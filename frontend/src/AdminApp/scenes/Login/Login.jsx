    ...
    return(
        <div className="w-full bg-gradient-to-r from-white to-[#0d2569] h-screen grid md:flex items-center ">
            <div className="md:w-1/2 flex justify-center  ">
                <Link className="rounded-full p-5 bg-white bg-opacity-30 flex items-center" to="/"><FaHandsHelping size={30} className=" mr-2" /><h1 className="w-full text-3xl font-bold text-black">minglee-Admin</h1>
                </Link>
            </div>
